...
/**
 * Returns the message associated with the parse_size outcome.
 * @param outcome the outcome from which to get the message.
 * If not a valid ParseSizeOutcome, a message describing this is returned.
 * @return the error message associated with the parse_size outcome.
 */
char const* parse_size_outcome_to_msg(ParseSizeOutcome outcome);
